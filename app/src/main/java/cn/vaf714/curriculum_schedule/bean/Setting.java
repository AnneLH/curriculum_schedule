...
public class Setting {
    ...
    public static int getWeeks() {
        return (int) getParam("weeks", 22);
    }

    public static void setWeeks(int weeks) {
        setParam("weeks", weeks);
    }

    public static String getStartDate() {
        return (String) getParam("startDate", "2017-8-28");
    }

    public static void setStartDate(String date) {
        setParam("startDate", date);
    }
    ...
    private static void setParam(String key, Object object){
        ...
        SharedPreferences sp = LitePalApplication.getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
